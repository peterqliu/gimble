// copied from https://unpkg.com/three@0.126.1/examples/js/utils/BufferGeometryUtils.js
// to make sure Jest interprets this as ESM
...
var BufferGeometryUtils = {
	...
	mergeBufferGeometries: function ( geometries, useGroups ) {
		...
		for ( var name in attributes ) {
			...
			var mergedAttribute = BufferGeometryUtils.mergeBufferAttributes( attributes[ name ] );
